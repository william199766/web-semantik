...
<body class = "alert-warning">
	<nav class  = "navbar navbar-inverse">
		<div class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand">Sistem Informasi Bimbingan Smart One More</a>
			</div>
	...
	<div class = "container-fluid">
		<ul class="nav nav-pills">
			...
			<li class="active"><a href="club.php">MataKuliah</a></li>
		</ul>
		<br />
		<div class = "col-md-12 well">
			...
			<br/>
			<br/>
			<div class = "alert alert-warning">Mata Kuliah / Update</div>
			<div class = "row">	
				<div class = "col-md-2 ">
				</div>
				<div class = "col-md-2">
	...
	<footer class = "navbar navbar-fixed-bottom navbar-inverse">
		<label class = "pull-right">&copy; <?php echo date('Y', strtotime('+8 HOURS'))?> Developed By: <b>Theo Aleksander ,Willi,FikriBafadhal </b></label>
	</footer>
</body>	
