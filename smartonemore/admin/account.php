...
<body class = "alert-warning">
	...
	<div class = "container-fluid">
		<ul class="nav nav-pills">
			...
			<li><a href="club.php">Mata Kuliah</a></li>
		</ul>
		<br />
	...
	<footer class = "navbar navbar-fixed-bottom navbar-inverse" align="center">
			<strong>Copyright &copy; <?php echo date("Y") ?> Developer Universitas Maranatha <a href="https://web.facebook.com/theo.aleksander">TheoAleksander William,Willi,FikriBafadhal</a></strong>
	</footer>
</body>	
